...
if(isset($_POST['submit'])){
	...
	$sql = "INSERT INTO users(fname, lname, email, phone, adddress, username, pass) VALUES('$fname','$lname','NIL','$phone','NIL','$username','$pass')";
	$query = mysqli_query($con, $sql);

	if ($query == TRUE) {
		echo "<script>alert('User Added Successful ✔✔✔'); window.location='view_users.php'; </script>";
	}else {
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="POST" action="">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="email" placeholder="user@gmail.com" type="email" required/>
                            </div>
                        </div> -->
                        <!-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="example-datetime-local-input" class="col-sm-12 col-md-2 col-form-label">Gender</label>
                            <div class="col-sm-12 col-md-10">
                        ...
                        <!-- <div class="form-group row">
                            <label for="example-datetime-local-input" class="col-sm-12 col-md-2 col-form-label">Date 0f birth</label>
                            <div class="col-sm-12 col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <!-- <input type="text" name="cdate" value= "<?php echo $cdate; ?>" required /> -->
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10 input-icon">
                                <input class="form-control" name="pin" id="passwordField" placeholder="Enter PIN" type="password" required/>
                                <span class="icon" id="showPassword" onclick="pass()">&#128273;</span>
                            </div>
                        </div>

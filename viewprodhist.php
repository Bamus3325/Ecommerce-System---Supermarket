...
include '_include/connect.php';
$i =1;
$query = mysqli_query( $con, "SELECT * FROM product_history WHERE email = '{$_SESSION['email']}' AND prod_ids = '$id'");
while ( $row = mysqli_fetch_array( $query ) ) {
    ...
    ?>
                            ...
                            $id = $_GET['id'];
								include '_include/connect.php';
								$sql1 = "SELECT SUM(total) AS value_sum FROM product_history WHERE email= '{$_SESSION['email']}' AND prod_ids = '$id'";
                            ...
                            <tfooter>
                                ...
                                <th colspan="4"><a href="producthist.php" class="btn btn-primary btn-block">Back</a>
                                </th>
                                <tfooter>
                        </tbody>
                    </table>

                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a onclick="return confirm('Do you want to view this Product(s)?');"
                                            href='viewprodhist.php?id=<?php echo $row['prod_ids']; ?>' type='button'
                                            class='btn btn-primary btn-sm'>
                                            <i class='material-icons'>View Products</i>
                                        </a>

                                        <a href='#' data-id="<?php echo $row['id']; ?>"
                                            data-prod="<?php echo $row['prod_ids']; ?>" type='button'
                                            class='btn btn-warning btn-sm rate-link'>
                                            <i class='material-icons'>Rate & Feedback</i>
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="rateForm" action="submit_rating.php" method="POST">
                            ...
                            <input type="text" name="prod_ids" id="prod_ids">
    ...
    <script>
        $(document).ready(function() {
            $('.rate-link').click(function(e) {
                ...
                var prodIds = $(this).data('prod');
                $('#prod_ids').val(prodIds);

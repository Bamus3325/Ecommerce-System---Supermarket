...
if (move_uploaded_file($imagesync,$targetdir.$img)){
	...
	$sql = "INSERT INTO products(cdate, p_title, p_price, p_desc, t_prod, image) 
				VALUES('$c_date','$p_title','$p_price','$p_desc','$t_prod','$img')";
	$query = mysqli_query($con, $sql);

	if ($query == TRUE) {
		echo "<script>alert('Product Added Successful'); window.location='view_prod.php'; </script>";
	}else {
		echo "<script>alert('Product Not Added Successful'); window.location='view_prod.php'; </script>";
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input type="text" class="form-control" name="c_date" value="<?php echo $d; ?>"
                                    readonly>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="p_price" type="text" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="t_prod" type="text" required />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-datetime-local-input" class="col-sm-12 col-md-2 col-form-label">Product
